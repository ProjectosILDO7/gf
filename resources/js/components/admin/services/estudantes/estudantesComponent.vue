<template>
    <div class="container mt-4">
        ...
        <div class="row">
            ...
            <div
                class="form-group col-6 text-end mb-2"
                v-if="todosAlunosCount != 0"
            >
                <span class="rext-secondary">Total de estudantes:</span>
                <span class="rext-secondary fw-bold">
                    ( {{ todosAlunosCount }} )</span
                >
            </div>
        ...
        <!-- Înput search -->
        <form class="d-flex" role="search" v-if="todosAlunosCount >= 3">
        ...
        >
            <div class="card-body">
                <div class="row">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a
                                            ...
                                            aria-controls="offcanvasRight"
                                            @click="
                                                efectuarPagamento(estudante.id)
                                            "
                                        >
                                            <i
                    ...
                    <div
                        class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3"
                    >
                        <p class="text-secondary h6">
                            <span v-show="estudante.image">
                                <router-link
                                    :to="`${url}${estudante.image}`"
                                    target="_blank"
                                >
                                    <img
                    ...
                    >
                        ...
                        <p class="text-secondary h6">
                            <i
                                class="fa-solid fa-graduation-cap text-success"
                            ></i>
            ...
            >
                <li class="page-item" v-if="estudantes.current_page != 1">
                    <a
                        ...
                        href="#"
                        @click.prevent="
                            loadingEstudantes(estudantes.current_page - 1)
                        "
                        >{{ "<<" }}</a
                    >
                </li>
                ...
                <li
                    :class="[
                        'page-item',
                        { active: estudantes.current_page == page },
                    ]"
                    aria-current="page"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">
                            ...
                            <span v-if="btnSaveVariavel"
                                >Cadastre novos estudantes</span
                            >
                                ...
                                <div class="form-group col-12 text-center">
                                    ...
                                    >
                                        ...
                                        <div class="file-upload">
                                            <label
                                                for=""
                                                class="text-secondary col-12 text-start"
                                                >(Opcional) Selecione uma
                                                foto</label
                                            >
                                            <input
                                                type="file"
                                        ...
                                        <div
                                            v-if="items.imgPreview"
                                            class="col-12 mt-2 d-grid gap-2"
                                        >
                                            <button
                                                class="btn btn-sm btn-outline-danger cursor"
                                    ...
                                    <div class="file-upload-section" v-else>
                                        <label
                                            id="preview"
                                            for="file-upload"
                                            v-show="editImage"
        ...
        >
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">
                            <i class="fa-solid fa-trash text-danger"></i> Apagar
                            estudante
                        </h5>
                        <button
                            type="button"
                        ...
                        <div class="row">
                            <div class="form-group col-12 text-center">
                                <span class="text-primary">
                                    <h6>
                                        Tens a certeza que desejas apagar este
                                        estudante...?
                                    </h6>
                                </span>
                            </div>
                    ...
                    <div class="form-group col-12 mt-4">
                        <div class="card mt-2">
                            <div class="card-body">
                                <p class="text-success">
                                    Nº do documento pessoal:
                                </p>
                                <p
                                    class="text-secondary mt-0 fw-bold topoMargin"
                                >
                                    {{ info.numBI }}
                                </p>
                            </div>
                        ...
                        <div class="card mt-2">
                            <div class="card-body">
                                ...
                                <p class="text-success topoMargin">
                                    Senha de acesso:
                                </p>
                                <p
                                    class="text-secondary mt-0 fw-bold topoMargin"
